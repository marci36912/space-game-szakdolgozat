...
public class GunsCollection : MonoBehaviour
{
    ...
    private void Awake()
    {
        kollekcio.Add(new GunsNEW("Revolver", 1, 4, 0, 20, 1, 0.7f, false));         //0
        kollekcio.Add(new GunsNEW("Assault Rifle", 0.5f, 12, 0, 10,1, 0.55f, false)); //1     
        kollekcio.Add(new GunsNEW("Burst Rifle", 1.2f, 10, 0, 10, 3, 0.42f, false));  //2    
